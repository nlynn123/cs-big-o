...
// ANSWER:No, it depends on the length of the array. 
...
// ANSWER: The amount of data doesn't change in the first one, whereas the second one is dependent on the string that we input. 
